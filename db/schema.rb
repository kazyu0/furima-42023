...
ActiveRecord::Schema[7.1].define(version: 2025_02_15_072004) do
  ...
  create_table "destinations", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.index ["purchaser_id"], name: "index_destinations_on_purchaser_id"
  end
  ...
  add_foreign_key "destinations", "purchasers"
